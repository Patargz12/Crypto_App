...
const props = defineProps<{ bitcoinData: Coin }>();
</script>
  ...
  <div class="container-card-charts">
    <div class="card-charts">
      ...
      <div class="main-texts">
        <p class="title">BTC ${{ bitcoinData.current_price }}</p>
        <p
          :class="{
            'text-green-600': bitcoinData.price_change_percentage_24h > 0,
            'text-red-600': bitcoinData.price_change_percentage_24h < 0,
          }"
        >
